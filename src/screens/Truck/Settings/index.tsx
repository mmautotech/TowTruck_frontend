...
import { getDriverProfile } from '../../../api/Profile'; // Replace with getDriverProfile if needed

const TruckSettingsScreen: React.FC = () => {
  ...
  // Autofill phone on screen focus
  useFocusEffect(
    useCallback(() => {
      let active = true;
      ...
      const fetchPhone = async () => {
        try {
          const profile = await getDriverProfile(); // Replace with getDriverProfile if you have one
...
export default TruckSettingsScreen;
